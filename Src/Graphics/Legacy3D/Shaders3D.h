...
"uniform float fogDensity;        // was gl_Fog.density\n"
"uniform float fogStart;          // was gl_Fog.start\n"
"\n"
"// Vertex attributes that used to arrive through the fixed pipeline\n"
"attribute vec4  inVertex;        // was gl_Vertex\n"
"attribute vec3  inNormal;        // was gl_Normal\n"
"attribute vec3  inColor;         // was gl_Color\n"
"attribute vec2  inTexCoord;      // was gl_MultiTexCoord0\n"
"\n"
...
"varying vec4   fsColor;          // was gl_FrontColor\n"
"varying vec4   fsTexCoord;       // was gl_TexCoord[0]\n"
...
"  viewVertex = vec3(modelViewMatrix * inVertex);  \n"
"  \n"
"  /*\n"
"   * Modulation\n"
"   *\n"
...
"   */\n"
"\n"
"  fsColor = vec4(inColor, 1.0);  // untextured polygons will use this\n"
"  fsLightIntensity = vec3(1.0,1.0,1.0);\n"
"  if (texParams.x > 0.5)    // textured\n"
"    fsLightIntensity *= inColor.rgb;\n"
"    \n"
"  /*\n"
"    * Sun Light\n"
"   *\n"
...
"  {\n"
"    // Normal -> view space\n"
"    viewNormal = normalize(GetLinearPart(modelViewMatrix)*inNormal);\n"
"\n"
...
"  fsTexCoord = vec4(inTexCoord, 0.0, 1.0);\n"
...
"    uv_bot.xy = fsTexCoord.st-vec2(0.5,0.5); // move into the lower left blending texel\n"
...
"\n"
"  // Apply fog\n"
"  fragColor.rgb = mix(fragColor.rgb, fogColor.rgb, fsFogFactor);\n"
"\n"
"  // Store final color\n"
